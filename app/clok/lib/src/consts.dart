...
// MAKE SURE THIS MATCHES WITH Arduino Characteristics conts.
...
const String WIFI_STATUS = "00000017$SUFFIX_ID";
const String ROOTCA_URL = "00000031$SUFFIX_ID";
const String TZ_ZONEINFO_URL = "00000051$SUFFIX_ID";
const String TZ_REGION = "00000052$SUFFIX_ID";
const String TZ_TIMEZONES = "00000053$SUFFIX_ID";
const String TZ_TIMEZONE = "00000054$SUFFIX_ID";
const String TZ_REGIONS = "00000055$SUFFIX_ID";
